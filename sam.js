...
function colorGenerator(){
    var x = Math.floor((Math.random() * 260) + 1)
    var x1 = Math.floor((Math.random() * 260) + 1)
    var x2 = Math.floor((Math.random() * 260) + 1)
...
for(var i=0; i<footer2.length;i++){
    ...
    footer2[i].style.padding="20px"
    footer2[i].style.margin="10px"
    footer2[i].style.textAlign="center"

}

var list3 = document.querySelector("section ul")
list3.style.marginLeft="40%"
